...
from backbones.mobilenet.mobilenet26 import Mobilenet26
from utility.metrics_calc import convertLabelToProbability, cal_accuracy

###
###  A classifier using mobilenet26 as backbone is used to classify FashionMNIST dataset
###
...
class Classifier(nn.Module):
    ...
    def __init__(self, num_classes, in_channels=3):
        ...
        self.feature_extractor = Mobilenet26(in_channels=in_channels)
...
x = torch.randint(-5,5, (1,1,112,112)).float().to(device)
print(summary(model, (1,112,112)))
y = model(x)
print(y.shape)
print(y)
